...
public class ReglasInterfaz extends JFrame{
    ...
    public ReglasInterfaz(String[] reglas, int p_numeVariables,ArrayList<Variables> etiquetas_){
        super("ventanita");
        a_reglas = reglas;
                ...
                for (int i = 0; i < a_reglEquivalentes.size(); i++) {/*Recorre la lista con las reglas
                    intercambiadas por su valor equivalente*/
                     String cadena_valores[];
                         ...
                         minimo=Double.parseDouble(cadena_valores[0]);/*Establezco un minimo para copararlo*/
